...
class gsp_petShop_layoutsmain_gsp extends GroovyPage {
...
printHtmlPart(9)
if(true && (!c.name.equals("Dbdoc"))) {
printHtmlPart(10)
createTagBody(4, {->
expressionOut.print(c.name)
})
invokeTag('link','g',25,['controller':(c.logicalPropertyName)],4)
printHtmlPart(11)
}
printHtmlPart(12)
}
...
public static final long LAST_MODIFIED = 1457623755712L
